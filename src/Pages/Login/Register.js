    ...
    return (
        <div>
            <div className='flex justify-center py-8 shadow-xl ring-1 ring-gray-900/5'>
                <div className="relative flex flex-col max-w-md  rounded-md shadow-lg bg-white text-black">
                    {wait && <Loading2 />}
                        ...
                        <form onSubmit={handleSignup} className="space-y-12 ng-untouched ng-pristine ng-valid">
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="file" accept='image/*' name="photo" className="w-full px-3 py-2 border rounded-md border-gray-700 text-black" />
                                </div>
                            </div>
